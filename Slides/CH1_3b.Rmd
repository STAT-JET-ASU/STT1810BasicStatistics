...
* Find a standardized statistic from the observed proportion of “successes” in the data, the hypothesized mean of the null distribution (i.e., *the value of the parameter that is specified in $H_0$*), and standard deviation (SD) of the null distribution as produced by the [ISI One Proportion Applet](http://www.isi-stats.com/isi2nd/ISIapplets2021.html) (i.e., simulation).
* Interpret a standardized statistic.
* State a conclusion about the alternative hypothesis (and null hypothesis $H_0$) based on the magnitude of the standardized statistic.

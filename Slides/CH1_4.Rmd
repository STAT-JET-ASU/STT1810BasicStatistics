...
These slides are intended to accompany Section 1.4 What Impacts Strength of Evidence? in [*Introduction to Statistical Investigations, 2nd Edition*](http://www.isi-stats.com/isi/index2nd.html). 

*This content does not replace reading the textbook section.* It is for class presentation and/or reference in STT1810 Basic Statistics. Includes supplemental material about Type I and Type II errors.
...
* [Section 1.3 Alternative Measure of Strength of Evidence](https://stat-jet-asu.github.io/STT1810BasicStatistics/Slides/CH1_3.html)
* [Example 1.4 Predicting Elections from Faces?](https://stat-jet-asu.github.io/STT1810BasicStatistics/Slides/Example1_4.html)
...
* **extremeness:** The farther away the observed statistic is from the average value of the null distribution (i.e., the value that is specified for  $\pi$ in $H_0$), the more evidence there is against $H_0$.

* **sample size:** As the sample size increases (while the value of the observed sample statistic $\hat{p}$ and our $H_a$ stay the same) the strength of evidence against $H_0$ increases.

* **one- vs. two-sided $H_a$:** Because the *p*-value for a two-sided test is about twice as large as we would get for a one-sided test using the same data, it provides less evidence against $H_0$. (*Two-sided tests are used more often in scientific practice.*)
...
* What if I'd scored 9 correct instead of just 6 on the test?
...
|:----------------:|:-------------------:|:---:|:---------:|:---------:|:-----------:|
| $H_0:\pi = 0.20$ | $H_a:\pi > 0.20$    | 25  | 0.24      | 0.3810    | (*initial*) |
...
* Test says you do not have the virus---false negative (Type II error)
...
The risk of committing this error is the significance level (α) you choose. That is the value that you set at the start of your study to assess the statistical probability of obtaining your results just by random chance (i.e., your *p*-value).

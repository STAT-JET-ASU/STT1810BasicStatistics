...
In Chapter 1, you were generating hypothetical samples from a probability model to reflect our null hypothesis $H_0$. In that case, $\pi$ is a *hypothetical value* we assumed in $H_0$.

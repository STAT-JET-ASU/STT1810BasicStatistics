...
* We are taking samples of size $n$ that are large enough so that there are at least 10 successes and 10 failures in each sample.
...
If the three criteria on the previous slide are met, the sampling distribution of the sample proportion $\hat{p}$ will have the following properties.
...
Observe that $SD(\hat{p})$ gets progressively smaller as $n$ gets larger.

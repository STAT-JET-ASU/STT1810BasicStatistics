...
We are 95% confident that the long-run probability someone would prefer tap water to bottled water when presented with the kind of choice offered in the experiment is between -0.081 and 0.303, or effectively about 0% to 30.3%
...
Across two classes of students, 31 of 38 students $(\hat{p} = 0.816)$ assigned the name Tim to the left face. Using simulation, our estimated $SD = 0.081$.
...
All plausible values in the interval are greater than $50\%$. We can be confident that the true proportion $\pi$ is greater than random chance in this context.

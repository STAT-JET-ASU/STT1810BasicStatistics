---
title: "STT1810 --- Section 4.2<br>Studies / Experiments"
...
* <div style = "border-width:2px; border-style:solid;">Chapter 4 introduces the idea of **causation**, the last of the four pillars.</div>
...
In theory, given a randomized experiment, if we find a difference in lying between Internet and pencil-and-paper players, there are only two explanations: (1) cause-and-effect relationship or (2) random chance from the random assignment process.
...
Randomness influences the scope of conclusions we can draw.

```{r, echo = FALSE, fig.align="center"}
knitr::include_graphics("images/fig_04_02_03.jpg", dpi = 120)
```

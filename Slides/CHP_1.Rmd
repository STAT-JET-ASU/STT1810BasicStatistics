---
title: "STT1810 --- Section P.1<br>Intro to 6-Step Method"
...
* Think of / write research questions that could be investigated with a statistical study.
  ...
  *Investigation at any level is driven by **questions**; how we ask the question will shape our next steps in the process.*
...
```{r, echo = FALSE, fig.align="center"}
knitr::include_graphics("images/realworldvsdata.png", dpi = 150)
```

What is this cartoon trying to tell us about the nature of data?

---
title: "STT1810 --- Section P.2<br>Exploring Data (EDA)"
...
> * describing the behavior (distribution) of a variable
>    - shape
>    - center
>    - variability
...
```{r, echo = FALSE, fig.align="center"}
knitr::include_graphics("https://stat-jet-asu.github.io/Moodlepics/dotplot.jpg")
```
...
```{r, echo = FALSE, fig.align="center"}
knitr::include_graphics("https://stat-jet-asu.github.io/Moodlepics/histogram.png")
```
...
* The measurement is accurate, but the observational unit it was collected from does not belong to the group we intended to measure; for example, including a kindergartener's height in a dataset that is meant to answer a question about college students' biometric measurements.
...
*Extension:* Would a 60-year-old be an outlier in either group?

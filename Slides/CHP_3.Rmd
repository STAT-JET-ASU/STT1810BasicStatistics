...
**process:** an endless series of potential observations

**random process:** a repeatable process that has unknown individual (short-term) outcomes but a long-run pattern of outcomes

**probability:** the long-run proportion of times an outcome from a random process occurs

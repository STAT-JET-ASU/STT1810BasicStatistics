...
```{r}
knitr::include_graphics("images/CITI_02.jpg", dpi = 115)
```
...
```{r}
knitr::include_graphics("images/CITI_03.jpg", dpi = 115)
```
...
Use the **Copy** button to copy the link for submission.

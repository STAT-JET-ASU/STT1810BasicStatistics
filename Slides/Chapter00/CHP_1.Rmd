...
Can you think of some examples of categorical or quantitative you might encounter in your discipline?

Can you think of any categorical variable that uses a numerical value as a label? One example is Banner ID.
...
Examples of other quantitative variables include (1) number of home runs hit (2) total pitch count, (3) number of runs batted in (rbi), (4) number of at-bats, and (5) number of errors comitted. Can you think of more? (*Note: Many of the [common stats](https://www.baseball-reference.com/bullpen/Baseball_statistics) reported for players and teams are quantitative.*)

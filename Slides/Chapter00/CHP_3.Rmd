...
How can we simulate the random process [using a computer](https://www.random.org/), or a physical/tactile tool like coins, dice, cards, or a [spinner](https://shodor-education.github.io/interactivate/activities/AdjustableSpinner/#gsc.tab=0)?

...
* The default option in the application was to be a donor. Thus, people had to choose *not* to become a donor if they wished (the *opt-out* group).

* There was no default option in the application. People had to specifically choose to become a donor or not become a donor (the *neutral* group).
...
* 82.0 / 41.8 ≈ 2 &rarr; opt-out was *twice* as likely to agree as opt-in
* 78.6 / 41.8 ≈ 1.88 &rarr; neutral was 1.88 times as likely as opt-in 
...
Given the sample percentages and the sample size, they could be confident that the neutral version increases the probability a person will agree to be an organ donor by somewhere between 20% and 54%. [*We will learn about estimation in Chapter 3.*]
...
An ATS (*access to transplant*) score indicates the probability that a person on the U.S. transplant waitlist will get a transplant from a deceased donor. Variation in ATS scores reflects system fairness. *Less* variation means *more* fairness---the probabilities are more alike for all people on the waitlist. We will learn about **standard deviation** in Section P.2. (Source: [OTPN / UNOS](https://insights.unos.org/equity-in-access/))

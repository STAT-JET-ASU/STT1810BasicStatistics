...
The dataset that the authors include in the [Descriptive Statistics applet](https://www.isi-stats.com/isi2nd/ISIapplets2021.html) has more variables than the example in the textbook.
...
* [Country Music Hall of Fame performer Reba McEntire will sing the National Anthem at the 2024 Super Bowl.](https://ew.com/super-bowl-2024-performers-usher-halftime-reba-mcentire-national-anthem-8546391) 

* How could we use the data we have to make a prediction about how long her performance will last?

* What other information would you like to have that is not included the dataset?

...
Just because we have not yet found evidence for something we are studying does not necessarily mean it does not exist. When we work with samples, there is always some level of *uncertainty* (due to randomness) in our research findings.

...
Just because we have not yet found evidence for something we are studying, that does not necessarily prove it does not exist. When we use samples, there is always some level of *uncertainty* (due to randomness) in our research findings.

...
Our **<mark>*p*-value</mark>** is the probability of getting a purely random value of a statistic that is at least as extreme (*in the direction of $H_a$*) as the observed statistic we are assessing---assuming $H_0$ is true.
...
Researchers across many of disciplines consider **<mark>*p*-value ≤ 0.05</mark>** (i.e., ≤ 5% chance) to be the threshold where we can claim data have ***statistical significance*** and declare the chance model ($H_0$) to be implausible. 
...
## Our general rule: reject $H_0$ if...

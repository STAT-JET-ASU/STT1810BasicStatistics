...
The standardized value is also often referred to as the ***z*-score.**
...
When doing this rescaling, the original *units of measurement* for the data cancel out, which is why it's *standardized* and applicable across a broad range of possible problems. 

...
**standardize / standardized statistic:** To standardize a statistic, compute the distance of the observed statistic from the mean of the null distribution (*corresponding with $H_0$*), then divide by the standard deviation (SD) of the null distribution.

...
Consulting our guidelines, my *p*-value is between 0.01 and 0.05, so I have **strong evidence** against the null hypothesis.
...
When we reject a null hypothesis, we will accept the alternative (research) hypothesis. Here, that is : "The long-term probability of correctly identifying a card is greater than $0.20$."

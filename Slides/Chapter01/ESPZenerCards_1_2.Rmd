---
title: "Do You Have ESP?<br>Strength of Evidence #1"
...
*Using our parameter definition and two options:*
...
*Rewriting our hypotheses in statistical symbols:*
...
Now that we have established our parameter and hypotheses, we can consider the data we collected. 
...
**Strength of Evidence:** From my simulation, I obtained a *p*-value of **0.0490**. My actual statistic is located somewhat far out in the upper (right) tail, as we can also see on the simulation plot.
...
According to our guidelines, I have **strong evidence** against the null hypothesis. My results are **statistically significant** (unlikely to be due to just random chance). Therefore, I will reject $H_o$.TBA

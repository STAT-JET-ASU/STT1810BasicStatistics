...
The proportion is $15/16 = 0.9375$. We can also say $93.75\%$.
...
Doing a larger number of simulations gives us a better idea of the *long-run* probability for all the possible outcomes. Getting a count of 5 to 11 correct just by guessing is fairly likely (*typical*). 


## If We Did Infinite Simulations...

Below are the true long-run probabilities of getting counts of 0 to 16 correct, if Buzz is just guessing on each trial. Notice that 8 (50%) is the most common. *This requires doing a bit of math*...

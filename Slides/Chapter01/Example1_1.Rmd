...
Today, the Navy uses bottlenose dolphins (*Tursiops truncatus*) and California sea lions (*Zalophus californianus*) for a variety of tasks, including search, recovery, detection, and security.
...
**parameter:** Buzz’s actual long-run proportion (or *probability*) of pushing the correct button based on Doris’s whistles

**observational units:** Buzz's individual button-pushing attempts (often called *trials*)

**variable of interest:** whether Buzz pushed the correct button or incorrect button on each trial (categorical, binary)
...
To summarize these results, we report a numerical summary of the sample data called a  *statistic*. 

**Option 1: Count of Successes**

One way we can summarize the data is to report a count of how many times Buzz was correct. Here, that is $15$.
...
Here, that is $15/16 = 0.9375$; we can also say $93.75\%$.
...
Any number of successes from 0 to 16 is *possible* if Buzz is just guessing. This plot of simulation results shows us which of the possibilities are more *probable* or *likely* to happen.
...
Doing a larger number of simulations gives us a better idea of the *long-run* probability for all the possible outcomes. Getting 5 to 11 correct just by guessing is relatively likely. 


## If We Did Infinite Simulations...

True long-run probabilities of the possible outcomes 0 to 16, if Buzz is just guessing on each trial. *This requires a bit of math*...
...
If we zoom in on the distribution's upper tail, we can get an idea of how *very* unusual it is to get $15/16$ correct by just randomly guessing. As we said earlier, it is *possible*, but not *probable*.
...
Most traditional statistical methods are *approximations* that use probability theory and mathematics. You may have seen these in a research methods course or other courses where you have read published research articles.
...
In any case, we can see that getting $15$ out of $16$ correct just by randomly guessing is a *very* rare (*very low probability*) outcome, though it is not impossible.

Okay, so what do we conclude from this? 
...
Some conclusions will depend on how the study was designed and how we view the 16 observed attempts with regard to the bigger picture of the research question.

For example, we have assumed a few things about this study.
...
Naval Information Warfare Center Pacific. (n.d.). *Marine Mammal Program*. https://www.niwcpacific.navy.mil/About/Departments/Intelligence-Surveillance-and-Reconnaissance/Marine-Mammal-Program/


## Other Chapter 1 Slides

* Section 1.1 [Introduction to Chance Models](https://stat-jet-asu.github.io/STT1810BasicStatistics/Slides/Chapter01/CH1_1.html)
    * *Example 1.1 Can Dolphins Communicate?*
* Section 1.2 [Measuring the Strength of Evidence](https://stat-jet-asu.github.io/STT1810BasicStatistics/Slides/Chapter01/CH1_2.html)
    * Example 1.2 Rock-Paper-Scissors
* Section 1.3 [Alternative Measure of Strength of Evidence](https://stat-jet-asu.github.io/STT1810BasicStatistics/Slides/Chapter01/CH1_3.html)
    * Example 1.3 Heart Transplant Operations
* Section 1.4 [What Impacts Strength of Evidence?](https://stat-jet-asu.github.io/STT1810BasicStatistics/Slides/Chapter01/CH1_4.html)

...
If all the CLT ideas on the previous slide are true for a given situation, the sampling distribution of the sample proportion $\hat{p}$ will have the following distribution properties.

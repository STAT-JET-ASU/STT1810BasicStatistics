...
These slides are meant to accompany  [*Introduction to Statistical Investigations, 2nd Edition*](http://www.isi-stats.com/isi/index2nd.html) --- Section 2.1 Sampling from a Finite Population: Proportions. 
...
In Chapter 1, we generated many hypothetical samples from a specified probability model to coincide with our null hypothesis $H_0$. In those cases, $\pi$ is a *hypothetical value* we assumed.
...
**nonsampling concerns:** potential sources of bias (e.g., poorly worded survey questions, people lying) that are not related to the way the sample was selected from the population
...
If the key CLT ideas on the previous slide are true, the sampling distribution of the sample proportion $\hat{p}$ will have the following distribution properties.
...
&rarr; We call the SD of a sampling distribution its ***standard error***.

...
The **<mark>Central Limit Theorem</mark>** describes the sampling distributions of some statistics from finite populations, like $\hat{p}$ --- assuming we meet the necessary criteria or conditions. 
...
If the four CLT ideas on the previous slide are true for a given situation, the sampling distribution of the sample proportion $\hat{p}$ will have the following distribution properties.
...
Simulated sampling distribution using [One-Proportion](http://www.isi-stats.com/isi2nd/ISIapplets2021.html) applet. Notice the bell shape along with the mean and SD values.
...
Simulated sampling distribution using [One-Proportion](http://www.isi-stats.com/isi2nd/ISIapplets2021.html) applet. Notice the shape is *slightly* right skewed. *Why is that true?*

...
We will do Sections 2.1 and 2.2. They introduce the idea of the sampling distributions of $\hat{p}$ and $\bar{x}$, built from a large number of random samples of size $n$ drawn from a finite population. Also, the ***Central Limit Theorem***.
...
* However, we are taking random samples of size $n$ that are big enough so that there are at least $10$ successes and $10$ failures in each sample.  

...
The Central Limit Theorem describes the sampling distributions of certain statistics from finite populations, like $\bar{x}$ --- if we meet the necessary criteria. As in Section 2.1, here we are considering statistics from large, finite populations.

...
However, this is sample data, and we all know that it has some random variability. Maybe $\pi$ is slightly different than $0.90$, like $0.89$. Could it be more different, like $0.80$? Or even $0.70$? 
...
Testing values less than $0.89$ for the smallest plausible value of $\pi$, using a series of two-tailed tests, we get $0.71$.

...
* We addressed breadth of results (generalization) in Chapter 2. ✔ ***Great work!***
...
<p style = "text-align: center; background: yellow;">increased ↑ confidence = increased ↑ width</p>
...
<p style = "text-align: center; background: yellow;">increased ↑ sample size = decreased ↓ width</p>
...
<p style = "text-align: center; background: yellow;">the proportion $\hat{p}$ being farther from 0.50 =<br>the proportion $\hat{p}$ is closer to 0 or closer to 1 =<br>decreased ↓ sampling variability = decreased ↓ width</p>
...
**This difference is sometimes known as *statistical significance* versus *practical significance*. The latter (*practical*) implies that what we find is big enough to be useful in real life.**
...
Much of the specific discussion in Section 3.4 is framed around theoretical confidence intervals, which we did not cover. But, in general, the ideas apply to all types of confidence intervals. 

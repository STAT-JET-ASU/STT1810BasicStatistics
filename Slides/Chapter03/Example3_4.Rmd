...
**Note :** The confidence intervals in this example were calculated using a theory-based method that is related to our 2SD method, but the ideas apply to all types of confidence intervals.

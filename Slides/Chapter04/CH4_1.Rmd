...
**<mark>explanatory variable</mark> :** if the alternative hypothesis is true, this is the variable that explains changes in the response variable (it may also be called an **independent** or **predictor variable**). 
...
**<mark>response variable</mark> :** if the alternative hypothesis is true, this is the variable that is impacted by the explanatory variable (it is also sometimes known as a **dependent** or  **predicted variable**)
...
***Example 2:*** In our observed relationship between asbestos and mesothelioma in a previous example, or between smoking and a long list of diseases, the presence or absence of the diseases (or their severity) are the response variables to the explanatory variable of smoking.
...
You may also see references to what are called **<mark>lurking variables</mark>** in some texts or videos. The distinction often made between the two is that lurking variables are confounding variables that are *not measured or accounted for* in the study. 

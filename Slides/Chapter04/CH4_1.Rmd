...
Alternative definition: two variables are *associated* (or related) if the value of one variable gives you information about the value of the other variable. When comparing groups, the proportions or means of one variable (***response** or **dependent** variable*) are different within different groups (*categories of the **explanatory** or **independent** variable*).

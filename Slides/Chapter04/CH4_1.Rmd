...
**<mark>associated</mark> :** two variables are associated or related to each other if the distribution of one variable is different across the values of the other variable --- knowing something about one variable gives us information about the other

***Example 1:*** In the game of Monopoly, as you move around the four sides of the board from the starting space **Go**, each side has higher prices than the preceding side. Thus, side and price are associated.

***Example 2:*** People who develop a rare type of cancer known as mesothelioma are more likely to have been previous exposure to asbestos fibers and dust. 

***Example 3:*** Smoking cigarettes is associated with several medical problems, such as lung cancer, heart disease, COPD, and stroke. 
...
***Example 1:*** In Example P.2, we explored the duration (in minutes) of Super Bowl national anthem performances. We considered a few other variables like gender and performer's genre of music to try to explain the differences in performance lengths.

***Example 2:*** In our observed relationship between asbestos and mesothelioma, asbestos exposure is the explanatory variable, since it precedes the person developing the disease. The same would be true for smoking and various diseases.

***Example 3:*** In elementary school, children in higher grades tend to be taller than children in lower grades. In this case, age is the explanatory variable for observed height differences.
...
***Example 3:*** In elementary school, children in higher grades tend to be taller than children in lower grades. In this case, age is the response variable is the observed differences in height.

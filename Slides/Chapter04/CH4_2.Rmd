...
**<mark>cause and effect</mark> :** if we do a randomized experiment, we can conclude that the explanatory variable is causing the effect (difference or association) we see in the response variable (*the randomization balances possible confounding variables*)

...
## Preview: ISI [Two Proportion](https://www.isi-stats.com/isi2nd/ISIapplets2021.html) Applet
...
Just like we did with the One Proportion applet, we will perform a simulation and get a *p*-value from the observed statistic, which is interpreted using the same guidelines. Since ***p*-value = 0.0199**, have strong evidence against $H_0$.

...
An example with three variables: sex, survival, and ticket class. Does ticket class seem to be associated with sex and survival? Look at the different survivor proportions between the graphs. Which sex and ticket class had the highest survival probability?
...
Women were about three and a half times as likely to survive the sinking of the Titanic as men.

$$\%IR = \frac{0.73 - 0.21}{0.21} \times 100\% = 248\% \approx 250\%$$

Women had about a 250% increased chance of survival versus men when the Titanic sank.

...
These slides are meant to accompany [*Introduction to Statistical Investigations, 2nd Edition*](http://www.isi-stats.com/isi/index2nd.html) --- Section 5.1 Comparing Two Groups: Categorical Response.
...
## An Example: Risk of Oral Cancer
...
Data can be entered as a two-way table in [this applet](https://www.isi-stats.com/isi2nd/ISIapplets2021.html). It can also calculate RR and OR values. Here you see the oral cancer data.

```{r, echo = FALSE, fig.align="center"}
knitr::include_graphics("../images/twopropapplet.png", dpi = 135)
```

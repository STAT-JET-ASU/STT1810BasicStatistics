...
There were more male passengers than female aboard Titanic.


## 

**<mark>relative risk</mark> :** the **ratio** of conditional proportions that indicates how many times greater the risk of some observed outcome is for one group, as compared to the risk of the same outcome in another group (also sometimes called **<mark>risk ratio</mark> **)

$$RR = \frac{\text{proportion (risk) in explanatory category 2}}{\text{proportion (risk) in explanatory category 1}}$$

Which group we call Category 1 and which group is Category 2 depends on the problem context. If we have a control group or "baseline" group for comparison in our study, that group usually will go in the denominator (i.e., the bottom of the fraction).

Essentially, **<mark>risk</mark>** is another word for **<mark>probability</mark>** or proportion. In everyday English, we usually associate the word "risk" with some kind of bad outcome. However, in statistics we can use the term risk for any outcome we are interested in.


## An Example: Risk of Oral Cancer

[Oral cancer](https://www.nidcr.nih.gov/health-info/oral-cancer) is a family of malignancies that includes cancers of the mouth and the back of the throat. Smoking, alcohol use, sun exposure, and poor nutrition are some of the variables that are associated with this type of cancer. Consider here the observed incidence of oral cancer in groups of smokers and non-smokers. ***Smoking is the explanatory variable.***
...
## The [Two-Proportions]((https://www.isi-stats.com/isi2nd/ISIapplets2021.html)) Applet

Data can be entered as a two-way table. It can also calculate RR and OR values using the **Statistic:** drop-down menu. Try it!

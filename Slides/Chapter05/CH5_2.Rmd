...
We also encountered it in Section 3.2 when we introduced the idea of 2SD confidence intervals.
...
Recall the oral cancer example from Section 5.1. This is a test of significance for that data. The [Two Proportions](https://www.isi-stats.com/isi2nd/ISIapplets2021.html) applet generates the null distribution by randomly *re-shuffling* the data.
...
## The Complete Test of Significance
...
## Scope of Inference and Cause/Effect

...
$\pi_1$ = the conditional population proportion of successes for the *response variable* within Group 1 of the *explanatory variable*

$\pi_2$ = the conditional population proportion of successes for the *response variable* within Group 2 of the *explanatory variable*

* $H_0:$ The conditional proportion of successes in Group 1 is the same as the conditional proportion in Group 2.

...
Has the rate of seatbelt usage changed from 2008 to 2018?
...
What is the % of seatbelt use, conditional on (*within each*) year?
...
(2018 rate of use) &ndash; (2008 rate of use) = 89.6% &ndash; 83.0% = 6.6% 

A greater percentage of people used seatbelts in 2018 vs. 2008. This represents *thousands* of drivers and passengers.
...
In 2008, the probability of observing a driver or front passenger wearing a seatbelt was 0.83. In 2018, it was 0.83 plus 8% of 0.83 (0.83 + 0.08 x 0.83), which gives us the observed 0.896 in 2018. There was an 8% *change* in probability from the baseline.
...
What have we learned from our exploration of the data?

* There was an increase from 2008 to 2018 in the proportion of people tht were observed using seatbelts.

* There was an increase from 2008 to 2018 in the total number of states that have primary seatbelt laws.

* In 2008 and 2018, the percentage of seatbelt use appears to be larger in the states that have primary seatbelt laws versus states with only secondary seatbelt laws.

Can we therefore potentially infer the following: *time &rarr; changes in seatbelt laws &rarr; increases in seatbelt use*? Why or why not?
...
Before thinking about *p*-values and confidence intervals, does using those kinds of inferential methods make sense here? 

With such a large sample size, almost any observed difference might be found to be statistically significant.

In Section 5.2, you will learn how to use simulation to compare two proportions (e.g., difference in conditional proportions). 

The NOPUS seatbelt study uses “complex, multistage samples” that require additional statistical tools beyond the level of this course --- although the *logic* is the same that you are learning. 
...
One confounding variable could be that states enacting primary seatbelt laws also have more miles of interstate, and people are more likely to wear seatbelts on interstates than smaller roads. 

We also have not considered any “margin of error” in these data. Even if we find a meaningful difference, it is only about seatbelt usage, not about traffic fatalities or other driver metrics.

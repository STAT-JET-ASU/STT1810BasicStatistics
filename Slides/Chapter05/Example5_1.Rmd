...
More people are using seatbelts --- this is thousands of drivers and passengers, given the sample size.
...
Can we therefore infer that: time &rarr; changes in seatbelt laws &rarr; greater seatbelt use? 

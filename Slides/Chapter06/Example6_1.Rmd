...
Their answer is the information presented on the previous slide about being able to predict eruptions, and also that the number *might* have decreased a little over time. Perhaps we can better explore this question by examining some data.
...
The skewness statistic for 2003 is strongly negatively, largely due to the two low outliers identified (56 and 58 minutes). If they are removed, skewness drops to 0.11. The distribution plot appears to be roughly symmetric if we disregard the two outliers.

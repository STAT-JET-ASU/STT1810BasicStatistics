...
You can also put the data into the [Descriptive Statistics](https://www.isi-stats.com/isi2nd/ISIapplets2021.html) applet to visualize the plots together and calculate standard deviation.  

<hr>

Note: We will once again consider positive vs. negative distance from the mean in Chapter 1 when we learn about *z*-scores.

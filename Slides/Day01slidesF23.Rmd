...
```{r}
knitr::include_graphics("images/missteeny.jpg", dpi = 1250)
```
...
Research shows that up to 80% of college students experience “feelings of anxiety ... when taking a statistics course or doing statistical analyses” [(cite)](https://psycnet.apa.org/fulltext/2019-01035-001.html). So it's not unusual, but does *not* have to get in the way of your success in this class!
...
```{r}
knitr::include_graphics("images/GrowthMindset.png", dpi = 110)
```
...
It is very difficult to learn statistics by just listening to someone talk. In class, we will be using hands-on activities to engage with multiple parts of your brain.
...
```{r}
knitr::include_graphics("images/thinkpairshare02.png", dpi = 400)
```
...
```{r}
knitr::include_graphics("images/experientialcycle.png", dpi = 400)
```

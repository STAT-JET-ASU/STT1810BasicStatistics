...
subtitle: "Introductory Zener Card Exploration"
...
The term ESP refers to collection of abilities, including telepathy (mind reading), psychokinesis (moving objects without physical contact) and precognition (predicting the future). Sometimes it is called "the sixth sense" or "psi". 
...
What might **anecdotal evidence** (e.g., personal observations of striking examples) consist of in the context of trying to figure out whether some people *really* possess ESP ability? Why is this kind of "evidence" less valid that a statistical investigation?

...
In our Zener card ESP test, the ***parameter of interest*** is the long-run probability that the person who is being tested can correctly identify the symbol on a card. Logically, given the testing set-up, we would expect someone who is purely guessing to get 20% of the presented cards correct by random chance.

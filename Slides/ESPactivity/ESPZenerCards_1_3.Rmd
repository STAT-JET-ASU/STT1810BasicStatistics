...
Scores for other $\hat{p}$ values below, above, and equal to the mean*.
...
My result of 9 (36%) cards correct, with its *z*-score of 2, would be considered ***statistically significant***, which means it is unlikely to be the result of just random chance. With such strong evidence, we would say the chance model is ***implausible*** and reject $H_0$. So, we accept $H_a$. This finding agrees with my *p*-value results. 

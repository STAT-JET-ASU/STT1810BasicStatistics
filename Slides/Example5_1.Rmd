---
title: "STT1810 --- Example 5.1<br>Buckling Up?"
...
The original study report with additional details can be found at [crashstats.nhtsa.dot.gov/Api/Public/Publication/809646](crashstats.nhtsa.dot.gov/Api/Public/Publication/809646) (pdf).
...
The count of seatbelt users is smaller in 2018, but there are also fewer observations in that year than in 2008.
...
rate of use in 2018 &ndash; rate of use in 2008 = 89.6% &ndash; 83.0% = 6.6% more people using seat belts --- this is thousands of drivers and passengers, given the sample size
...
The bar for 2008 is wider because the sample size was larger.
...
In June 2008, primary laws were in effect in 26 states and DC, 23 states had secondary laws, and one state (NH) effectively had no law. By 2018, there were 8 more primary states. What does this plot help us understand about seat belt use?
...
* There was an increase from 2008 to 2018 in the number of people observed using seat belts.

* There was an increase from 2008 to 2018 in the number of states that have primary seat belt laws.

* In 2008 and 2018, the percentage of seat belt use seems to be larger in the states that have primary versus secondary seat belt laws.

Can we infer that time &rarr; changes in seat belt laws &rarr; greater seat belt use? Is it an *association* or *causation*?


## STEP 4: Draw Inferences

Before thinking about *p*-values and confidence intervals, does doing so make sense here? 
...
Researchers have to be careful about the scope of conclusions they draw from this kind of observational study; we will discuss this further in Step 5.

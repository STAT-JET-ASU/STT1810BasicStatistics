---
title: "STT1810 --- Example 5.1<br>Are People Buckling Up?"
...
**Buckle up, it’s the law!** How often do you use your seat belt? If you are not a regular seat belt user, is there anything that might change your behavior?
...
* The law requires use of the entire seat belt system present. Unless a seating position has a lap-belt-only seat belt, both the lap and shoulder belt must be properly worn. Placing a shoulder belt behind the back/under the arm is not allowed.
...
The U.S. government has been monitoring the use of seat belts for years. In particular, they want to decide whether changes in seat belt laws appear to increase seat belt usage, and in general how seat belt usage is changing over time.
...
* **response variable:** seat belt use (yes/no); binary categorical variable
...
Does seat belt use seem to have changed from 2008 to 2018?
...
More people are using seat belts --- this is thousands of drivers and passengers, given the sample size.
...
So for every 100 people observed wearing seat belts in 2008, we would see an *additional* 8 people in 2018.
...
In 2008, the probability of observing a driver or front passenger wearing a seat belt was 83%. In 2018, it was 83% plus 8% of 83% (0.83 + 0.08 x 0.83), which gives us the observed 89.6% in 2018. There was an 8% *change* in probability from the baseline.
...
In June 2008, 26 US states and DC had primary seat belt laws, 23 states had secondary laws, and one state (NH) effectively had no seat belt law. By 2018, eight more states had primary laws. *What does this plot help us understand about seat belt use?*
...
* There was an increase from 2008 to 2018 in the proportion of people observed using seat belts.

* There was an increase from 2008 to 2018 in the total number of states that have primary seat belt laws.

* In 2008 and 2018, the percentage of seat belt use appears to be larger in the states that have primary seat belt laws versus secondary seat belt laws.

Can we therefore infer that: time &rarr; changes in seat belt laws &rarr; greater seat belt use? 

Would the relationship be an *association* or *causation*?
...
The NOPUS seat belt study uses “complex, multistage samples” that require additional statistical tools beyond the level of this course --- though the *logic* is the same that you are learning. 
...
One motivation for this study is the idea that wearing seat belts saves lives. If enacting primary laws leads to more people using seat belts, can we conclude that primary laws save lives?
...
One confounding variable could be that states with primary seat belt laws also have more interstates and folks are more likely to wear seat belts on interstates than on smaller roads. 

We also have not considered any “margin of error” in these data. Even if we find a meaningful difference, it is only about seat belt usage, not about traffic fatalities.
...
"The 2020 observed belt use rate among front-seat occupants was about 6 times the rate observed in 1983 (90 percent vs. 14 percent) ([Transportation Research Board, 2003](https://onlinepubs.trb.org/onlinepubs/sr/sr278.pdf))."


##

```{r, echo = FALSE, fig.align="center"}
knitr::include_graphics("images/seatbeltlaws.png", dpi = 140)
```

"In 2020, observed front-seat occupant belt use rates were 5 percentage points higher in states with primary enforcement than in other states (91 vs. 86 percent) ([National Center for Statistics and Analysis, 2021](https://crashstats.nhtsa.dot.gov/Api/Public/ViewPublication/813072.pdf))."

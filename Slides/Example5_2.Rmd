...
* $\pi_\text{dolphin}$ = the probability of significant improvement after swimming with dolphins
...
In the text, there were 13 simulated differences $\ge$ 0.4667, so the *p*-value is 0.013, which provides strong evidence against $H_0$.
...
We can estimate the magnitude of the difference between two parameters with a confidence interval. Recall what we learned in Section 3.2, with a little modification for this scenario...

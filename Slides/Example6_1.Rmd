...
* [Section 6.1 Geyser Eruptions](https://stat-jet-asu.github.io/STT1810BasicStatistics/Slides/CH6_1.html)
...
Their answer is the information presented on the previous slide about being able to predict eruptions, and that the number may have decreased a little over time. Perhaps we can better explore this question by examining some data.

**research question:** Has there been a change in Old Faithful's eruption pattern between 1978 and 2003?
...
Here we have $\bar{x}_{2003} - \bar{x}_{1978}$ = 91.2 - 71.1 = 20.1 minutes. Is this difference just random chance, or has Old Faithful's underlying process changed?

The same method could also be used to compare two *medians*, if the median is a better measure of center. 

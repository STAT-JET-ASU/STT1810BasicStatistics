...
What if a person can do better than guessing? To simplify our model, we will assume their chance is the same for every game. What $\pi$ matches with the NCAA's "know a little something"?
